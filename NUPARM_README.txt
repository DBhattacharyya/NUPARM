...
1-4 (1989)).
In the web version of NUPARM
(http://nucleix.mbu.iisc.ernet.in/nuparm/nuparm.shtml) the various options 
available in the original version of NUPARM have been restricted to some 
standard ones. 
...
NUPARM can be used in two ways:
 ...
 Options: -notdouble [default=double] 
      ...
      -overlap (to calculate base pair stacking overlap between successive
base pairs) [default=No]
...
(I5, 1x, I5) format for a duplex. This file can be generated by BPFIND 
software (http://www.saha.ac.in/biop/bioinformatics.html).  The name of that 
...
global axis. The realignment is done in two steps: (i) the best line is fitted 
(by the method of least squares) to a set of representative points taken 
either from all the residues, or the doublet steps. The molecule is rotated 
such that this line becomes parallel to the global Z-axis. (ii) The same 
representative points are used to find the mean point through which the line 
